...
function doIt
 {
  ...
  echo; echo "Step 20): installing Internet music tools ..."
  ...
  echo
  echo "Step 21) installing Local NLP..."
  ...
  echo
  echo "Step 22) installing Local STT..."
  ...
  echo
  echo "Step 23) installing Local TTS..."
  ...
  echo
  echo "Step 24) copying and enabling systemd .mount and .service files..." 
  ...
  echo 
  echo "Step 25) copying Minimy scripts to /usr/local/sbin..."
  ...
  echo 
  echo "Step 26) copying great_songs playlist to /var/lib/mpd/playlists..."
  sudo cp $HOME/minimy/install/great_songs.m3u /var/lib/mpd/playlists
  
  echo 
  echo "Step 27) starting virtual environment..." 
