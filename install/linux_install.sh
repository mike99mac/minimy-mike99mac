...
sudo apt-get -q install python3-venv
sudo apt-get -q install python3-dev
python3 -m venv venv_ngv
source venv_ngv/bin/activate
pip install --upgrade pip
pip install --upgrade wheel setuptools
pip install setuptools -U
sudo apt-get -q install -y python3-dev
sudo apt-get -q install -y build-essential
sudo apt-get -q install -y portaudio19-dev
sudo apt-get -q install -y mpg123
