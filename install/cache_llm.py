...
def _get_log_file():
  cfg = Config()
  base_dir = cfg.get_cfg_val("Basic.BaseDir") or os.environ.get("SVA_BASE_DIR") or os.getcwd()
  log_dir = os.path.join(base_dir, "logs")
  os.makedirs(log_dir, exist_ok=True)
  return os.path.join(log_dir, "llm_download.log")
...
def main():
  ...
  try:
    _log(f"Downloading LLM model {repo_id} ({filename}) on host {socket.gethostname()}")
